...
public class AuthenticationImpl implements AuthenticationService {
    ...
    @Inject
    private AuthenticationImpl(ConfigurationService configurationService, IEncodeUtils iEncodeUtils) {
    ...
    public boolean connect(String username, String password) {
        ...
        String pathFileToFindPassword = configurationService.get("application.security.file.pwd");
        ...
        try {
            String passwordFromFile = Files.toString(file, Charset.defaultCharset());
